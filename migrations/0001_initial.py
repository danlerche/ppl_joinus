# Generated by Django 4.2.1 on 2023-09-09 17:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(help_text='The label of the form field, cannot be one of the following: Your Name, Email, Your Phone Number.', max_length=255, validators=[ppl_joinus.models.validate_label], verbose_name='label')),
